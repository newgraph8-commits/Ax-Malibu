...
export const metadata: Metadata = {
  title: "Privacy Policy | Ax Malibu",
  description: "Privacy Policy for Ax Malibu executive search services.",
}
        ...
        >
          <div className="max-w-4xl">
            ...
            <div className="prose prose-lg max-w-none space-y-8 text-gray-700 leading-relaxed">
              <section>
                <p className="text-lg">
                  Ax Malibu ("we," "our," or "us") is committed to protecting your personal information and maintaining
              ...
              <section className="pt-4">
                ...
                <p>
                  Ax Malibu does not knowingly collect personal information from individuals under the age of 16. Our
              ...
              <section className="pt-4">
                ...
                <div className="mt-4 space-y-2">
                  <p className="font-semibold">Ax Malibu Privacy Office</p>
                  <p>
                    Email:{" "}
                    <a href="mailto:info@axmalibu.com" className="text-[#FF2B2B] hover:underline">
                      info@axmalibu.com
