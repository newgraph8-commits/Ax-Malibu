        ...
        <section className="pt-48 pb-16 lg:pt-56 lg:pb-24">
          <div className="container mx-auto" style={{ paddingInline: "clamp(1rem, 4vw, 3rem)" }}>
            ...
            <p className="text-lg text-muted-foreground leading-relaxed mb-12">
              Ax Arctic brings the specialized expertise required to guide organizations through the complex transitions
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-12">
              ...
              <div className="lg:col-span-3">
                ...
                <div className="prose prose-lg max-w-none">
                  ...
                  <p className="text-lg text-muted-foreground leading-relaxed mb-6">
                    From there, Ax Arctic moves through a coordinated series of steps that includes identifying
